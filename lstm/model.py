...
class SentimentLSTM(nn.Module):
    ...
    def __init__(self, n_vocab, n_embed, n_hidden, n_output, n_layers):
        super().__init__()
        ...
        self.lstm = nn.LSTM(n_embed, n_hidden, n_layers, batch_first=True, bidirectional=False)
...
class BiLSTM(nn.Module):
    ...
    def forward(self, input_words, hidden):
        ...
        lstm_out = lstm_out[:, :, :self.n_hidden] + lstm_out[:, :, self.n_hidden:]
        lstm_out = self.dropout(lstm_out)
